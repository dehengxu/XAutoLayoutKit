...
Pod::Spec.new do |s|
  ...
  s.name         = "XAutoLayoutKitSwift"
  s.version      = "0.3.0-beta"
  s.summary      = "XAutoLayoutKitSwift is a small collection of auto layout convenient utils."

  s.description  = <<-DESC
                   A longer description of XAutoLayoutKitSwift in Markdown format.
